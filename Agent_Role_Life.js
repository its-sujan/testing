...
describe('Agent Role for Life type',function(){
 ...
 before(function () {
		...
		cy.wait(5000)
		cy.visit('https://staging.assurance.com/rep/plate?lead_id=201367')
 ...
 beforeEach(function () {
	...
	it('Navigation', function() {
		...
		cy.get('#hinet-purchased_from_assurance > :nth-child(2) > label').click()

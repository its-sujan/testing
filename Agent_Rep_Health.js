...
describe('Health flow by Agent',function(){
	...
	it('Visit Lead',function(){
		...
		cy.visit('https://staging.assurance.com/rep/plate?lead_id=201376')	
	...
	it('Top Bar Menu > Notes',function(){

		cy.get('#rep-plates-notes-launcher > :nth-child(2)').click()
		cy.get('#rep-plates-drawer-content > #rep-plates-notes-bar > form > .form-group > #rep-plates-notes-bar-text-area').type('Health Insurance')
	...
	it('Navigation > Insurance Type Rep Redirect',function(){	
		cy.get('#rep-plates-drawer-content > #rep-plates-plate-nav-bar > #plates > :nth-child(2) > .plate-name > span').click()
		cy.wait(4000)
		cy.get('#rep-plates-nav-bar-launcher > :nth-child(2)').click()
		// cy.get('#rep-plates-profile-launcher').click()

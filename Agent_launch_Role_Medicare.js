...
describe('Medicare flow by Agent Launch',function(){
	...
	before(function(){
		...
		cy.visit('https://staging.assurance.com/rep/plate?lead_id=201310')
		cy.wait(5000)
	})
	...
	it('Update Notes',function(){
		...
		cy.get('.vertically-scrollable textarea').type('Adding the notes for Medicare')
	...
	it('Name',function(){
		...
		cy.get ('#edit-plates-profile-edit-name .mdc-layout-grid__inner:nth-of-type(1) .mdc-textfield__input').type('Saroja')
		cy.get('#edit-plates-profile-edit-name .mdc-layout-grid__inner:nth-of-type(2) .mdc-textfield__input').clear()
		cy.get('#edit-plates-profile-edit-name .mdc-layout-grid__inner:nth-of-type(2) .mdc-textfield__input').type('Tester')
	...
	it('Date of Birth',function(){
		...
		cy.get('#edit-plates-profile-edit-dob > div.mdc-dialog__body.edit-plates-profile-body > div > div > div > div > input').clear()
		cy.get('#edit-plates-profile-edit-dob > div.mdc-dialog__body.edit-plates-profile-body > div > div > div > div > input').type('01/03/1965')
	...
	it('Gender',function(){
		...
		cy.get('#edit-plates-profile-radio-male').click()
	...
	it('Height',function(){
		...
		cy.get('#edit-plates-profile-edit-height .mdc-simple-menu__items [role="option"]:nth-of-type(21)').click()
	...
	it('Zip',function(){	
		...
		// cy.wait(3000)
		// cy.get('#plate-content > .row > :nth-child(2)').contains('Save & Next').click()
		// cy.wait(5000)

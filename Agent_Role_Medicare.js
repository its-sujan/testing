...
describe('Agent Role for Medicare type',function(){
...
before(function () {
		...
		cy.get('[type="email"]').type('qa_agentflow_agent@assurance.com')
...
beforeEach(function () {
	...
	it('Referal', function() {
		...
		cy.get(':nth-child(3) > :nth-child(1) > .mdc-textfield > .mdc-textfield__input').type('symon')
		cy.get('.mdc-textfield > #dob').type('10/18/1985')
		cy.get('#a-related-policy-radio-female').click()
		cy.get(':nth-child(8) > .mdc-layout-grid__cell--span-12 > .mdc-textfield > .mdc-textfield__input').type('memphis')
	...
	it('Navigation', function() {
		...
		cy.get('#plate-content > .row > :nth-child(1) > .btn').click()
		...
		cy.get('#rep-plates-drawer-content > #rep-plates-plate-nav-bar > #plates > :nth-child(5) > .plate-name > span').click()
		cy.wait(4000)

		// cy.get('#rep-plates-drawer-content > #rep-plates-plate-nav-bar > #plates > :nth-child(8) > .plate-name > span').click()
		// cy.wait(4000)

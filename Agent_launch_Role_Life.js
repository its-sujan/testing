...
describe('Life flow by Agent Launch',function(){
	...
	before(function(){
		...
		cy.visit('https://staging.assurance.com/rep/plate?lead_id=201365')
		cy.wait(5000)
	})
	...
	it('Update Note',function(){
		...
		cy.get('.vertically-scrollable textarea').type('Adding the notes')
	...
	it('Date of Birth',function(){
		...
		cy.get('#edit-plates-profile-edit-dob .mdc-textfield__input').clear()
	...
	it('Height',function(){
		...
		cy.get('#edit-plates-profile-edit-height .mdc-simple-menu__items [role="option"]:nth-of-type(20)').click()
	...
	it('City',function(){
		...
		cy.get('#edit-plates-profile-edit-city .mdc-textfield__input').type('Bellevue')
	...
	it('State',function(){
		...
		cy.get('#edit-plates-profile-state-select > div > ul > li:nth-child(49)').click()
		cy.get('#edit-plates-profile-update-location-button').click()
		cy.wait(5000)
	})
	...
	it('Zip',function(){
		...
		cy.get('#edit-plates-profile-edit-zip .mdc-textfield__input').type('98512')
		cy.get('#edit-plates-profile-update-location-button').click()
		cy.wait(3000)
		...
		cy.wait(5000)
		cy.get('#rep-plates-drawer-content > #rep-plates-plate-nav-bar > #plates > :nth-child(7) > .plate-name').click()
